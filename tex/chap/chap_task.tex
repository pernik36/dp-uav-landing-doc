...
\paragraph{Úlohou} v~této práci je využití konkrétní přistávací metody k~řízení letadla vznášejícího se ve světě simulovaném simulátorem za působení vnějších vlivů v~dohledu plošiny tak, aby na ni dosedlo. Při tom se sleduje odchylka od požadované trajektorie, doba trvání, výpočetní náročnost, poloha po dosednutí a další veličiny, podrobnosti o~nich jsou v~\refskl{chap:eval}{kapitole}.