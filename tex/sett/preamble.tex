...
\usepackage[backend=bibtex,style=ieee,citestyle=ieee,natbib=true,sorting=ynt,block=ragged]{biblatex} 
...
\usetikzlibrary{positioning, fit, arrows.meta, shapes, babel, shapes.geometric, 3d} % for arrow size
